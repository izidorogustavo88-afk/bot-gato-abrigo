...
# PROTEÇÃO: O código agora puxa as chaves direto da Railway, sem mostrar nada no GitHub
OPENROUTER_API_KEY = os.environ.get("OPENROUTER_API_KEY")
TELEGRAM_TOKEN = os.environ.get("TELEGRAM_TOKEN")
NOME_PLANILHA = "gatos_abrigo.xlsx"

# Inicialização do cliente OpenRouter (OpenAI)
client = OpenAI(
...
# Instrução ultra rígida para a IA não se confundir no chat
INSTRUCOES_AGENTE = """
...
def main():
    ...
    # Sistema de reconexão automática em loop infinito contra quedas de rede
    while True:
        try:
